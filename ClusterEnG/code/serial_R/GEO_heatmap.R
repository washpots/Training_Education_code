...
#system("python /heatmap/inchlib_clust-0.1.4/build/lib.linux-x86_64-2.7/inchlib_clust.py /education/output/heatmap_vals.csv -dh -a both -o /education/output/heatmap_vals.json -mv NA")
